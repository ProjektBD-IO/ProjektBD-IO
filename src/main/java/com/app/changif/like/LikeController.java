...
public class LikeController {
    ...
    @PostMapping("/like")
    public ResponseEntity<?> like_gif(@RequestParam Integer id_gif, Principal principal) {
        Integer userId=Integer.parseInt(principal.getName());
        return likeService.likeGif(id_gif, userId);
    }
    @PostMapping("/dislike")
    public ResponseEntity<?> dislike_gif(@RequestParam Integer id_gif, Principal principal) {
        Integer userId=Integer.parseInt(principal.getName());
