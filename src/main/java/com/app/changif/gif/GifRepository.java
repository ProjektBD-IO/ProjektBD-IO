...
public interface GifRepository extends JpaRepository<Gif,Long> {
    ...
    @Query("select g, c.category_name from Gif g JOIN FETCH Category c on g.category=c.id_category where g.tags like %:tag% and gifType=true order by addDate desc")
